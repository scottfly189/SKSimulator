...
👉 本键鼠模拟器也支持 C++ 集成。  
- x86 架构：包含并链接 `x86/HKM.h` 和 `x86/hkm.lib`  
- x64 架构：包含并链接 `x64/HKM.h` 和 `x64/hkm.lib`  
...
- Windows 操作系统
- 键鼠模拟器硬件设备。本 SDK 需要配合硬件使用，如需硬件设备，请[联系我](device.md)
...
**更多的使用注意事宜与全部的标准API接口** 请参考 [SKSimulator 官方文档](https://scottfly189.github.io/SKSimulator/)
...
- [使用SKSimulator的开发框架 - 微信自动化.net框架 - WeChatAuto.SDK](https://github.com/scottfly189/WeChatAuto.SDK.git)
